...
namespace DBGames.Models
{
    public class EnginesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EngineId,EngineName,WrittenIn")] Engine engine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EngineId,EngineName,WrittenIn")] Engine engine)
        {
            if (ModelState.IsValid)
            {
