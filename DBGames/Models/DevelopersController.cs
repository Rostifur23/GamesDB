...
namespace DBGames.Models
{
    public class DevelopersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DeveloperId,DeveloperName,HQ")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DeveloperId,DeveloperName,HQ")] Developer developer)
        {
            if (ModelState.IsValid)
            {
