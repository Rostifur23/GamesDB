...
namespace DBGames.Models
{
    public class PlatformsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlatformId,PlatformName,Type")] Platform platform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlatformId,PlatformName,Type")] Platform platform)
        {
            if (ModelState.IsValid)
            {
